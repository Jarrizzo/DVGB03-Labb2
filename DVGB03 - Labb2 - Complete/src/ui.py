...
class TerminalUI:
    ...
    def show_2d(self):
        ...
        currentIndex = 0
        Padding = 5
        totalWidth = (pow(2,height-1) * Padding) + pow(2,height - 1)

        for i in range(height):
            ColumSpace = int(totalWidth / ((pow(2,i))+1) - (i/2))
            print(" " * ColumSpace,end = " ")
#            print(" " * pow(2,i), end = " ")
        
            for j in range (pow(2,i)):
                if nodes[currentIndex] == None:
                    print("*",end = "")
                else:
                    print(nodes[currentIndex],end = " ")
                currentIndex += 1
                print(" " * ColumSpace,end = " ")
            print("")
